...
A vonzáskörzetet EBBEN A SORRENDBEN építsd fel:
 ...
 b) Az anchor UTÁN következik a VALÓDI napi ingázó-gyűrű: az anchorba vezető fő közúti és vasúti folyosók mentén fekvő KISVÁROSOK és nagyközségek. Ezek adják a tényleges napi merítést. Tipikus hiba, amit kerülj el: a megye ismert nagyvárosait felsorolni a valódi ingázó települések helyett. Ha a listádon csak megyeszékhelyek és országosan ismert városok szerepelnek, a lista majdnem biztosan rossz — nevezd meg konkrétan az anchor körüli szűkebb gyűrű településeit (Győr körül pl. Mosonmagyaróvár, Csorna, Pannonhalma, Tét, Abda, Nyúl, Kapuvár; Székesfehérvár körül pl. Mór, Bicske, Polgárdi, Martonvásár, Velence, Gárdony, Várpalota; Pécs körül pl. Komló, Szigetvár, Mohács, Bóly). A gyűrű legyen TELJES: járd körbe az anchort, és a főbb bevezető irányok MINDEGYIKÉBŐL nevezd meg a jelentős települést — jellemzően 4-7 helyet. Ne állj meg két-három után. Egy kihagyott, nyilvánvaló szomszéd (Győr mellől Mosonmagyaróvár, Székesfehérvár mellől Mór) ugyanolyan súlyos hiba, mint egy túlnyújtott lista.
 A gyűrűt a SZEREP SZAKTERÜLETE szerint rangsorold, ne pusztán a közelség vagy a lakosságszám szerint. Ha a szerep egy ágazathoz kötődik (gyártás, ipar, logisztika, egészségügy, pénzügy), akkor annak az ágazatnak a MUNKAERŐ-KÍNÁLATI központjait nevezd meg elsőként — azt a közeli várost, ahol az adott szakma ténylegesen dolgozik. Egy ipari szerepnél egy gyárváros értékesebb merítés, mint egy nagyobb, de alvótelepülés-jellegű elővárosi gyűrű; ilyenkor az általános agglomerációs települések helyett a térség gyártási és beszállítói központjait sorold fel.
 ...
 d) HATÁR MENTI ANCHOR (pl. Győr, Sopron, Mosonmagyaróvár, Szeged, Debrecen, Békéscsaba, Nyíregyháza, Esztergom, Komárom): a szomszédos ország ingázási zónájára UGYANAZ a bérszint-teszt vonatkozik, mint a nagyvárosokra a c) pontban. A napi, határon átnyúló ingázás valós idő- és költségterhet jelent, ezért belépő szintű vagy adminisztratív bérszinten NEM reális elsődleges merítés — egy asszisztensi fizetésért senki nem kel át naponta a határon. Szakértői, mérnöki és vezetői sávban viszont igen: OTT alapértelmezetten vedd fel — különösen ahol jelentős magyar ajkú lakosság él (szlovák oldalon a Csallóköz: Dunaszerdahely, Somorja, Komárno, valamint Bratislava agglomerációja; a romániai és szerbiai határsáv). Ez nem "evidencia hiányában elhagyható" elem, hanem ezeknek a városoknak az alapvető utánpótlási csatornája. A határt NE tekintsd automatikus akadálynak; csak akkor hagyd ki, ha a brief nyelvi, jogi vagy engedélyezési okból kizárja.
...
Mielőtt továbblépnél: ellenőrizd, hogy a "search_elasticity" összhangban van-e a felsorolt helyekkel — MINDKÉT irányban:
- ha szűk, helyi ingázó-gyűrűt írtál le (az anchor körüli kisvárosok), akkor az elasticity "tight" — nem "moderate" és nem "loose";
...
UTOLSÓ ELLENŐRZÉS a geo_scope lezárása előtt: (a) szerepel-e az anchor a catchment_places első elemeként? Ha nem, vedd fel. (b) A lekérdezésekben megnevezett MINDEN helynek szerepelnie kell a catchment_places listában is. Ha egy városra rákeresel, de a vonzáskörzetben nem tünteted fel, a keresési terv önmagával kerül ellentmondásba — ilyenkor vedd fel a helyet a listára, indoklással együtt.
...
A KERESÉS CÉLPONTJA SZEMÉLY, NEM ÁLLÁSHIRDETÉS. Minden lekérdezés olyan oldalakat célozzon, ahol EGY KONKRÉT EMBER szakmai nyoma van: publikus profil (site:linkedin.com/in, site:github.com, site:xing.com), céges csapat- vagy vezetőségi oldal, konferencia-előadói bio, szakmai kamarai/egyesületi tagnévsor, sajtóinterjú vagy szakcikk szerzője, egyetemi oktatói és alumni oldal. SOHA ne célozz állásportált vagy hirdetés-gyűjtőt (profession.hu, cvonline.hu, jobline.hu, qjob.hu, workania, indeed, jooble, monster, glassdoor, facebook.com/jobs, "/allasok/" útvonalak, céges karrier-aloldalak) — ezek a MUNKÁLTATÓ hirdetéseit adják vissza, nem jelölteket, és a keresés így önmagát üresíti ki. Ha egy lekérdezés jellemzően hirdetést hozna, írd át személy-orientáltra. Szintén kerüld a szó szerinti feladat- és tapasztalat-stringeket ("3 év tapasztalat", "board meeting", "naptárkezelés") — ezek zajra (jegyzőkönyvek, hirdetések, cikkek) illeszkednek; szerep-, cég- és szakterület-jelzőket használj helyettük.

SZENIORITÁSI SÁV: a lekérdezések a brief tényleges szintjét célozzák. Belépő/junior szerepnél célozd a junior sávot (gyakornok, junior, pályakezdő, friss diplomás, a helyi egyetem releváns szakja) ÉS zárd ki a szenior titulusokat negatív szűrővel (pl. -"Head of" -Manager -Director -Lead -Owner). Szenior vagy vezetői szerepnél fordítva: a szenior titulusokat célozd, a gyakornoki/junior zajt zárd ki. A rossz szenioritási sáv ugyanolyan hiba, mint a rossz földrajz.

"firecrawl_search_queries" — a SZŰK kör, ami a nyilvános webes felkutatást vezérli (Google-stílusú, site: operátorokkal). FIGYELEM: a "szűk" NEM azt jelenti, hogy minden must_have egyetlen stringbe kerül. Egy lekérdezés LEGFELJEBB 3-4 megkülönböztető feltételt ÉSeljen: a szerep magja + a helymegjelölés + egy-két valóban diszkrimináló szakmai jel. A must_have-eket OSZD SZÉT a lekérdezések között, mindegyikben más kombinációval — így a halmaz EGYÜTT fedi le a követelményeket, de egyetlen lekérdezés sem szűkül nullára. Soha ne ÉSelj egy stringbe minősítést, két nyelvet, több módszertant és több technológiát egyszerre: ilyen adatok egy nyilvános profilon szinte soha nem szerepelnek EGYÜTT, ezért a találat nulla lesz — a jelölt pedig attól még létezik, csak nem írta ki magáról mindet. A cél nem a tökéletes szűrés, hanem az elég jó merítés: a végső szűrést a recruiter végzi, nem a lekérdezés. ÉS "firecrawl_search_queries_broad" — a TÁG kör: csak a szerep magja (cím/terület), az elengedhetetlen feltételek szigorú kombinációja NÉLKÜL; ez akkor kerül ténylegesen lekérdezésre, ha a szűk kör kevés találatot hoz. MINDKÉT listába sződ bele az (1) pontban megírt geo_scope.catchment_places helyeit releváns helymegjelölésként (pl. a catchment helynevei OR-kapcsolással, ahogy egy éles kereső-lekérdezésben természetes lenne) — a lekérdezések földrajza kövesse a te saját geo_scope-indoklásodat, ne csak a position.location szó szerinti nevét. KÖTELEZŐ: a szűk listában legalább egy olyan lekérdezés legyen, amely az anchoron KÍVÜLI catchment-helyet is megnevezi; ha csak az anchor neve szerepel az összes lekérdezésben, a földrajzi munkád kárba veszett. Ez a "loose" keresésekre is vonatkozik: ilyenkor a felvett országos és nemzetközi központokat (pl. Bécs, Pozsony, Prága, Varsó, London) ténylegesen nevezd meg a lekérdezésekben, ne csak a geo_scope-ban. Boolean lekérdezéseket is adj a szokásos platformokra.
${LANG}
